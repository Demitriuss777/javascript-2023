...
//
//
//     document.write(`<div> <h1> Блок  </h1> </div>`);
// }
...
// for (let i = 1; i <= 10; i++) {
//     document.write(`<div> <h1>${i} Приклад2  </h1> </div>`);
// }
...
/*let i = 1;
while (i <= 20) {
    document.write(`<h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, numquam?</h1>`)
    i++
}*/
...
// let i = 1;
// while (i <= 20) {
//     document.write(` <h1> ${i} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab illo nemo quod.</h1>`)
// i++
// }
